...
namespace network
{
    ...
    public class RemoteConcurrentServer : ConcurrentServer
    {
        private IServices server;
        private ClientWorker worker;
        public RemoteConcurrentServer(string host, int port, IServices server) : base(host, port)
        {
            this.server = server;
            Console.WriteLine("RemoteConcurrentServer...");
        }
