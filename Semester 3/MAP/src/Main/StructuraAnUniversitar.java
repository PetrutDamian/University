...
public class StructuraAnUniversitar {
    ...
    public static LocalDateTime[] getWeeks() {
        ...
        weeks[10] = LocalDateTime.of(2019,11,15,23,59,59);
        weeks[11] = LocalDateTime.of(2019,11,22,23,59,59);
        weeks[12] = LocalDateTime.of(2019,11,29,23,59,59);
        weeks[13] = LocalDateTime.of(2020,1,5,23,59,59);
